...
test_that("CRAFTDRE returns an object inheriting both CRAFTDRE and npsych_scores", {
  result <- CRAFTDRE()
...
test_that("CRAFTDRE sets class with CRAFTDRE first, npsych_scores second", {
  result <- CRAFTDRE()

  expect_equal(class(result), c("CRAFTDRE", "npsych_scores"))
})
...
test_that(".setup_CRAFTDRE_versions registers the 'nacc' norms version", {
  expect_true("nacc" %in% list_method_versions(CRAFTDRE(), "norms"))
})

test_that(".setup_CRAFTDRE_versions registers the 'updated' norms version", {
  expect_true("updated" %in% list_method_versions(CRAFTDRE(), "norms"))
})
...
test_that(".setup_CRAFTDRE_versions registers the 'updated_2024.06' regression version", {
  expect_true(
    "updated_2024.06" %in% list_method_versions(CRAFTDRE(), "regression")
  )
})

test_that(".setup_CRAFTDRE_versions registers the 'updated_2025.06' regression version", {
  expect_true(
    "updated_2025.06" %in% list_method_versions(CRAFTDRE(), "regression")
  )
})

test_that(".setup_CRAFTDRE_versions registers the 'nacc' regression version", {
  expect_true("nacc" %in% list_method_versions(CRAFTDRE(), "regression"))
})
...
test_that(".setup_CRAFTDRE_versions sets the default method to 'regression' / 'updated_2025.06'", {
  default <- get_std_defaults(CRAFTDRE())
