...
test_that("REYDREC returns an object inheriting both REYDREC and test_scores", {
  result <- REYDREC()
...
test_that("REYDREC sets class with REYDREC first, test_scores second", {
  result <- REYDREC()

  expect_equal(class(result), c("REYDREC", "test_scores"))
})
...
test_that(".setup_REYDREC_versions registers the expected methods", {
  methods <- get_std_methods(REYDREC())
...
test_that(".setup_REYDREC_versions registers the 'ravlt_trials' norms version", {
  expect_true("ravlt_trials" %in% get_versions(REYDREC(), "norms"))
})
...
test_that(".setup_REYDREC_versions registers the 'updated_2024.06' regression version", {
  expect_true("updated_2024.06" %in% get_versions(REYDREC(), "regression"))
})

test_that(".setup_REYDREC_versions registers the 'updated_2025.06' regression version", {
  expect_true("updated_2025.06" %in% get_versions(REYDREC(), "regression"))
})
