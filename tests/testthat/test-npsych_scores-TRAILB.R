...
test_that("TRAILB returns an object inheriting both TRAILB and npsych_scores", {
  result <- TRAILB()
...
test_that("TRAILB sets class with TRAILB first, npsych_scores second", {
  result <- TRAILB()

  expect_equal(class(result), c("TRAILB", "npsych_scores"))
})
...
suppressMessages(.setup_TRAILB_versions())


test_that(".setup_TRAILB_versions registers the expected methods", {
  methods <- list_std_methods(TRAILB())
...
test_that(".setup_TRAILB_versions registers the 'nacc' norms version", {
  expect_true("nacc" %in% list_method_versions(TRAILB(), "norms"))
})

test_that(".setup_TRAILB_versions registers the 'updated' norms version", {
  expect_true("updated" %in% list_method_versions(TRAILB(), "norms"))
})
...
test_that(".setup_TRAILB_versions registers the 'updated_2024.06' regression version", {
  expect_true(
    "updated_2024.06" %in% list_method_versions(TRAILB(), "regression")
  )
})

test_that(".setup_TRAILB_versions registers the 'updated_2025.06' regression version", {
  expect_true(
    "updated_2025.06" %in% list_method_versions(TRAILB(), "regression")
  )
})

test_that(".setup_TRAILB_versions registers the 'nacc' regression version", {
  expect_true("nacc" %in% list_method_versions(TRAILB(), "regression"))
})
...
test_that(".setup_TRAILB_versions sets the default method to 'regression' / 'updated_2025.06'", {
  default <- get_std_defaults(TRAILB())
