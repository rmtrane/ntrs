...
test_that("REY6REC returns an object inheriting both REY6REC and test_scores", {
  result <- REY6REC()
...
test_that("REY6REC sets class with REY6REC first, test_scores second", {
  result <- REY6REC()

  expect_equal(class(result), c("REY6REC", "test_scores"))
})
...
test_that(".setup_REY6REC_versions registers the expected methods", {
  methods <- get_std_methods(REY6REC())
...
test_that(".setup_REY6REC_versions registers the 'ravlt_trials' norms version", {
  expect_true("ravlt_trials" %in% get_versions(REY6REC(), "norms"))
})
...
test_that(".setup_REY6REC_versions registers the 'updated_2024.06' regression version", {
  expect_true("updated_2024.06" %in% get_versions(REY6REC(), "regression"))
})

test_that(".setup_REY6REC_versions registers the 'updated_2025.06' regression version", {
  expect_true("updated_2025.06" %in% get_versions(REY6REC(), "regression"))
})
