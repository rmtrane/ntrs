...
# test_that("OTRLARR returns an object inheriting both OTRLARR and npsych_scores", {
#   result <- OTRLARR()
...
# test_that("OTRLARR sets class with OTRLARR first, npsych_scores second", {
#   result <- OTRLARR()

#   expect_equal(class(result), c("OTRLARR", "npsych_scores"))
# })
...
#   .setup_OTRLARR_versions()
#   expect_equal(length(list_std_methods(OTRLARR())), 0L)
# })
