...
OTRAILB <- new_npsych_scores(
  ...
  short_descriptor = "Oral Trail Making Test Part B - Total number of seconds to complete",
  range = c(0, 300),
  codes = c(
...
.setup_OTRAILB_versions <- function() {
  var_name <- NULL
  lookup_table <- normative_summaries$updated$OTRAILB
