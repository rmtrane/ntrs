...
#'
#' @export
UDSVERLC <- new_npsych_scores(
  "UDSVERLC",
  label = "L Words",
  domain = "Language",
  short_descriptor = "Number of correct L-words generated in 1 minute",
  range = c(0, 40),
  codes = c(
    "Physical problem" = 95,
...
.setup_UDSVERLC_versions <- function() {
  ...
  lookup_table <- normative_summaries$nacc$UDSVERLC
  ...
  lookup_table <- normative_summaries$updated$UDSVERLC
